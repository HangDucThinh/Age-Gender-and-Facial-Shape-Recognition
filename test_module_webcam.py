...
shape_model = load_model('faceshape.h5')
age_model = load_model('Age.h5')
gender_model = load_model('gender (1).h5')
...
content="Age, Gender, and Facial Shape Recognition"
lb01=Label(tk,fg="blue",bg="white",font="Times 18",text=content)
lb01.pack()
lb01.place(x=210,y=10)
#Hien thi ten khung hinh
lb04=Label(tk,text="IP Webcam",font="Times 12",fg="blue",bg="white")
# lb04=Label(tk,text="Webcam",font="Times 15",fg="blue",bg="white")
lb04.pack()
lb04.place(x=380,y=80)
##### Hien thi so luong loai###
lb11=Label(tk,fg="blue",bg="white",font="Times 18",text="Age: ")
lb11.pack()
lb11.place(x=90,y=450)
lb12=Label(tk,fg="blue",bg="white",font="Times 18",text="Gender: ")
lb12.pack()
lb12.place(x=280,y=450)
lb13=Label(tk,fg="blue",bg="white",font="Times 18",text="Shape: ")
lb13.pack()
lb13.place(x=520,y=450)
#Khoi tao camera bằng IP Webcam
url='http://192.168.0.182:8080/video'
